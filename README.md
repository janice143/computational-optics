...
<p align="center">
  <img src="./assets/readme/hero.png" width="100%" alt="Computational Optics Lab — three scalar diffraction propagation models (Angular Spectrum Method, Fresnel, Fraunhofer) at z = 10 mm, plus the mean-squared-error evidence curve against propagation distance.">
</p>
...
**[janice143.github.io/computational-optics](https://janice143.github.io/computational-optics/)**.
